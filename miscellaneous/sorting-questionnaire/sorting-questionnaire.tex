...
<<<<<<< HEAD:miscellaneous/sorting-questionnaire/sorting-questionnaire.tex
<<<<<<< HEAD:miscellaneous/sorting-questionnaire/sorting-questionnaire.tex
	\item Sie sollen für jede Aufgabe eine Einschätzung einzeichnen, für wie wahrscheinlich Sie es halten, die Aufgabe zu 0\%, 10\%, 20\%, 40\%, etc. korrekt gelöst zu haben. Auf der x-Achse befinden sich also die prozentualen Anteile der bestmöglichen Bewertung. 
	\item Im Folgenden finden Sie dazu einige Beispiele:
=======
=======
>>>>>>> c2455aeeef536e1eb590b332ef2892c3a235f135:miscellaneous/Questionnaire Sorting/acs-questionnaire-sorting.tex
